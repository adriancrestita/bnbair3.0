...
//        costeNoche=Integer.parseInt(inmueble.getPrecioNoche());
    ...
    private void initComponents() {
        ...
        panelPrincipal.add(jSeparator4);
        ...
        panelPrincipal.add(jSeparator6);
        ...
        panelPrincipal.add(editButton);
        panelPrincipal.add(jSeparator7);
        ...
        panelPrincipal.add(numero);

        ciudad.setEnabled(false);
        ciudad.setFocusable(false);
        panelPrincipal.add(ciudad);
        panelPrincipal.add(jSeparator8);

        jLabel21.setText("Numero de Camas:");
        panelPrincipal.add(jLabel21);
        ...
        baños.setValue(1);
        panelPrincipal.add(baños);

        jLabel17.setText("Calle");
        panelPrincipal.add(jLabel17);
