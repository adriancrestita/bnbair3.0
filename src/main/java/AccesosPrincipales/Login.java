...
public class Login extends javax.swing.JFrame {
    ...
    if (email.equals("") || email.equals(mensajeOriginalCorreo)) {
        ...
        if (email.equals("admin@javabnb.com") && password.equals("admin")) {
            MenuAdmin pantallaAdmin = new MenuAdmin();
            ...
            if (cliente != null) {
                ...
                MenuParticular pantallaCliente = new MenuParticular();
            ...
            if (anfitrion != null) {
                Sesion.iniciarSesion(email);
                MenuAnfitrion pantallaAnfitrion = new MenuAnfitrion();
